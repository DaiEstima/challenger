...
var button1 = document.querySelector('button.btn_1');
button1.onclick = encrypt;

var button2 = document.querySelector('button.btn_2');
...
function encrypt() {
    ...
    if (input1.value.length == 0) {
        ...
        document.getElementById('copy').innerHTML = '<button class="button btn_3" onclick="copy()">Copiar</button>';
